...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            //PRADO This is to call another activity
            Intent intJS = new Intent(this,JsActivity.class);
            startActivity(intJS);
        }
   ...
   public void onClick(View view) {
       ...
       if (!url.getText().toString().isEmpty())
            testWebView.loadUrl("http://"+url.getText().toString());
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.admin.mywebview/http/host/path")
        );
